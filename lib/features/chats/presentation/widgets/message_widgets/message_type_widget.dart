...
import 'package:whatsappclone/features/chats/presentation/widgets/message_widgets/message_audio_widget.dart';
import 'package:whatsappclone/features/chats/presentation/widgets/message_widgets/message_video_widget.dart';

class MessageTypeWidget extends StatelessWidget {
  final String? type;
  final String? message;
  const MessageTypeWidget({Key? key, this.type, this.message})
      : super(key: key);
